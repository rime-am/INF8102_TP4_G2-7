...
t = Template()
t.set_description("Question 3.1")
...
##############################################################################
#        Question 2 : ajout du VPC flow logs pour les paquets rejetés        #
##############################################################################
...
with open("Q3.1/vpc_flow_logs.yaml", "w") as f:
    f.write(t.to_yaml())

print("Template générer avec succès pour la question 3.1!")
